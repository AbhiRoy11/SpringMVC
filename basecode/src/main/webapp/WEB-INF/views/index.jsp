...
<head>
 ...
 <style>
  ...
  #section2 {padding-top:50px;height:650px;color: #fff; background-color: #673ab7;}
 ...
 <!-- Modal -->
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div class="form-group">
      ...
      <input type="Name" class="form-control" id="First Name" placeholder="Enter First Name" name="Name">
    </div>
    <div class="form-group">
      <label for="Name">Last Name:</label>
      <input type="Text" class="form-control" id="Last Name" placeholder="Enter Last Name" name="Name">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="pwd" placeholder="Re-Enter password" name="pwd">
    </div>
...
<p>The strong bond of friendship is not always a balanced equation;
friendship is not always about giving and taking in equal shares.
 ...
 who will be there for you when you need something, no matter what or when.
<b>BY Anonymous</b>
</p>
</div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="/res/images/friendship.jpg" alt="Friendship" >
      </div>

      <div class="item">
        <img src="<c:url value='/res/images/friend.jpg'/>" alt="Friend" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="/res/images/happy-friendship-day.jpg" alt="happy-friendship-day" style="width:100%;">
      </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-header blue accent-1">
                        <h6><i class="fa fa-envelope"></i> Write to us:</h6>
                    </div>
